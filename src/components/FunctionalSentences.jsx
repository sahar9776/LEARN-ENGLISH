  ...
  return (
    <div className="w-[100%] h-auto py-16 " id='FunctionalSentences'>
      <div className="container ">
        <h3>جملات کاربردی</h3>
        <div className="w-full h-[600px] py-12 grid grid-cols-3 gap-5 relative">
          ...
          <div className=" hidden lg:block w-[190px] h-[190px] bg-secondary rounded-lg -rotate-45 absolute top-[273px] right-[-25px] opacity-85 z-10"></div>
          {
            functionalImage.map(item => (
              <Link to={`/functional-sentences/${item.category}`} className="group w-full h-[350px] border-2 shadow-md rounded-md cursor-pointer relative flex justify-center items-center text-center bg-white z-20" >
