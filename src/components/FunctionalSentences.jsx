...
function FunctionalSentences() {
  ...
  return (
    <div className="w-[100%] h-auto py-16 mx-auto" id='FunctionalSentences'>
      <div className="container ">
        <h3>جملات کاربردی</h3>
        <div className="w-full h-[650px] md:h-[600px] py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mx-auto relative">
